        ...
        <div className="min-h-screen flex flex-col items-center">
            ...
            <div className="bg-gradient-to-r from-blue-100 via-blue-200 to-blue-300  w-full mt-16 min-h-screen">
                <div className="text-center mt-20 px-4">
                    ...
                    <p>An AI-powered behavioral interview practice platform </p>
                </div>
                ...
                <div className='mt-28 max-w-6xl mx-auto'>
                    <div>
                        <h2 className='font-bold text-5xl'>Meet our AI interviewer MILBERT</h2>
                        <p className='text-2xl mt-8 mb-8'>Milbert is an AI interviewer that will rate your interview skills.</p>
                    </div>
                </div>
            </div>
            <div className='mt-16'>
