...
//         <select
//           className="p-2 border rounded"
//           value={selectedQuestion}  // Controlled input for selected question
//           onChange={(e) => setSelectedQuestion(e.target.value)}
//         >
//           <option value="">-- Choose a question --</option>
//           <option value="Tell me about yourself">Tell me about yourself</option>
...
//           {cameraEnabled ? <video ref={videoRef} autoPlay className="w-full h-full" /> : <span>Camera Off</span>}
//         </div>
//         {/* Pass the selected question as a prop to AudioRecorder */}
//         <AudioRecorder selectedQuestion={selectedQuestion} /> {/* Fixed line 60 */}
//       </div>
//     </div>
//   );
// }
